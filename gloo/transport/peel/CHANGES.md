...
### Core Peel Protocol (gloo/transport/peel/)
...
### Test Files (gloo/transport/peel/)
...
| File | Change |
|------|--------|
| context.h | Added PeelContext::init(), isPeelReady(), PeelContext::broadcast() methods |
...
| File | Change |
|------|--------|
| CMakeLists.txt | Added add_subdirectory(transport/peel) and Peel source files |
